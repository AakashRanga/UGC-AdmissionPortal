...
export function LoginPage({ onLoginSuccess, marbleOn = false, setMarbleOn }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 relative overflow-hidden font-sans">
      {/* Decorative Warm Ambient Glow Effects */}
      <div className="absolute top-1/4 -left-32 w-96 h-96 bg-amber-400/10 rounded-full blur-3xl pointer-events-none animate-pulse" />
      <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl pointer-events-none animate-pulse" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-500/5 rounded-full blur-[120px] pointer-events-none" />

      {/* Center Login Box */}
      <div className="w-full max-w-md relative z-10">
        <div className="glass-panel rounded-3xl p-8 sm:p-10 border border-slate-200/90 shadow-2xl backdrop-blur-xl animate-fade-in relative overflow-hidden bg-white/90">
          
          {/* Top Decorative Gold to Royal Blue Highlight */}
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-4">
              <img
                ...
                className="w-24 h-24 sm:w-28 sm:h-28 object-contain drop-shadow-md hover:scale-105 transition-transform duration-300"
              />
            </div>

            <h1 className="text-lg sm:text-xl font-extrabold text-slate-900 tracking-tight font-heading leading-snug">
              Saveetha Institute of Medical and Technical Sciences
            </h1>
            <p className="text-xs text-amber-700 mt-1 font-bold uppercase tracking-wider">
          ...
          {/* Error Banner */}
          {errorMessage && (
            <div className="mb-6 p-3.5 rounded-xl bg-rose-50 border border-rose-200 text-rose-700 text-xs flex items-start gap-2.5 animate-shake shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl glass-input text-xs font-medium text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-blue-500 transition-all shadow-sm"
                  required
                  autoFocus
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 rounded-xl glass-input text-xs font-medium text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-blue-500 transition-all shadow-sm font-mono"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full gradient-btn py-3.5 rounded-xl font-bold text-xs sm:text-sm text-white flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 shadow-md shadow-blue-700/25 mt-2"
            >
              {loading ? (
                <>
      ...
      {/* Minimal Marble Background Toggle on Login Page */}
      {setMarbleOn && (
